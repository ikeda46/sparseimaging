function [x,cost,LOOE] = MFISTA_L1_nonneg(y,A,xinit,lambda,cinit)
% function [x,cost,LOOE] = MFISTA_L1_nonneg(y,A,xint,lambda,c);
%
%    y: observed vector
%    A: matrix
...
%
%    min_x (1/2)||y-A*x||_2^2 + lambda*sum(x)
%    
%    x is nonnegative.
